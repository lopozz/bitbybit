...
from ml_zoo.transformers.attn import KVCacheHeadAttention


class KVCacheGPT2(nn.Module):
    def __init__(
        self,
        embed_dim,
        num_heads,
        ...
        self.blocks = nn.Sequential(
            *[KVCacheGPT2Block(embed_dim, num_heads) for _ in range(num_layers)]
        )
...
class KVCacheGPT2Block(nn.Module):
    def __init__(self, embed_dim, num_heads):
        super().__init__()

        self.attn_layer = KVCacheGPT2MultiHeadAttention(embed_dim, num_heads)
...
class KVCacheGPT2MultiHeadAttention(nn.Module):
